...
from picca import constants, io, prep_del, utils, xcf
...
def main(cmdargs=None):
    ...
    parser.add_argument(
        ...
        required=False,
        help=(
            "Angular cut (in degrees) between the foreground "
    ...
    parser.add_argument(
        ...
        required=False,
        help=(
            "Velocity cut (in km/s) between the foreground "
            "and the background quasars (to avoid "
            "contamination from redshift errors)."
        ),
    )
    ...
    parser.add_argument(
        ...
        required=False,
        help=(
            "Limit the minimum redshift of the absorber-tracer pairs that "
    ...
    parser.add_argument(
        ...
        required=False,
        help=(
            "Limit the maximum redshift of the  absorber-tracer pairs that "
            "contribute to the correlation function. If None, no cut is applied."
        ),
    )
    ...
    if args.shuffle_distrib_obj_seed is not None:
    ...
    results.write(
        ...
        names=["RP", "RT", "Z", "NB"],
        comment=[
            "R-parallel" if not xcf.rmu_binning else "Mu",
