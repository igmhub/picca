...
from picca.delta_extraction.expected_fluxes.dr16_fixed_varlss_expected_flux import (
    ...
    accepted_options as accepted_options3,
)
...
accepted_options = update_accepted_options(
    accepted_options,
    ["limit var lss", "num iterations", "use constant weight", "use ivar as weight"],
    remove=True,
)
...
class Dr16FixedEtaVarlssFudgeExpectedFlux(
    Dr16FixedEtaExpectedFlux, Dr16FixedVarlssExpectedFlux, Dr16FixedFudgeExpectedFlux
):
