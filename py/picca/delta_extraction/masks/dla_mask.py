    ...
    def __init__(self, config):
        ...
        try:
            with fitsio.FITS(filename) as hdul:
                ...
                if len(z_colname)>1 :
                     raise ValueError(f"Not clear which column should be used for the DLA redshift among {z_colname}. Please remove or rename one of the columns from the DLA fits file.")
