...
class chi2:
    ...
    def _minimize(self):
        ...
        mig_init = iminuit.Minuit(self,forced_parameters=self.par_names,errordef=1,**kwargs_init,print_level=1)
        mig_init.migrad()
        ...
        mig = iminuit.Minuit(self,forced_parameters=self.par_names,errordef=1,**kwargs,print_level=1)
        mig.migrad()
        mig.print_param()
