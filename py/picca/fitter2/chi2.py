...
class chi2:
    ...
    def __call__(self, *pars):
        ...
        chi2 = 0
        for d in self.data:
            chi2 += d.chi2(self.zeff,self.zref,self.k,self.pk_lin,self.pksb_lin,dic)
    ...
    def minimize(self):
        ...
        for d in self.data:
            d.best_fit_model = self.best_fit.values['bao_amp']*d.xi_model(self.zeff, self.zref, self.k, self.pk_lin-self.pksb_lin, self.best_fit.values)
            ...
            d.best_fit_model += d.xi_model(self.zeff, self.zref, self.k, self.pksb_lin, self.best_fit.values)
    ...
    def export(self):
        ...
        for d in self.data:
            ...
            g.attrs['chi2'] = d.chi2(self.zeff, self.zref, self.k, self.pk_lin, self.pksb_lin, self.best_fit.values)
