...
def send_cf_cross(
    zmin, zmax, do_corr, do_dist, do_met, f1="LYA", l1="LYA", f2="LYB", l2="LYA"
):
...
def parse():
    ...
    parser.add_argument(
        "--do_corr", action="store_true", help="compute correlation (auto or cross)"
    )
    parser.add_argument(
        "--do_dist",
        action="store_true",
    ...
    parser.add_argument(
        "--do_met", action="store_true", help="compute metal distortion matrix"
    )
