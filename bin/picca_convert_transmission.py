...
if __name__ == '__main__':
    ...
    parser.add_argument('--delta-log-lambda',
                        type=float,
                        default=3.e-4,
                        required=False,
                        help='Size of the rebined pixels in log lambda')

    parser.add_argument('--delta-lambda',
                        type=float,
                        default=None,
                        required=False,
                        help='Size of the rebined pixels in log lambda')

    parser.add_argument('--linear-spacing',
                        action="store_true",
                        default=False,
                        required=False,
    ...
    parser.add_argument('--use-splines',
                        action="store_true",
                        default=False,
                        required=False,
    ...
    raw_io.convert_transmission_to_deltas(
        args.object_cat,
        args.out_dir,
        in_dir=args.in_dir,
