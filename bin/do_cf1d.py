...
if __name__ == '__main__':
    ...
    head = [ {'name':'LLMIN','value':cf.lmin,'comment':'Minimum log10 lambda'},
             {'name':'LLMAX','value':cf.lmax,'comment':'Maximum log10 lambda'},
             {'name':'DLL','value':cf.dll,'comment':'Loglam bin size'},
    ]
