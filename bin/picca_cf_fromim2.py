...
if __name__ == '__main__':
    ...
    parser.add_argument('--from-image2', type=str, default=None, required=False,
        help='Read delta from image format', nargs='*')
    ...
    if args.in_dir2 or args.lambda_abs2 :
        ...
        data2, ndata2, zmin_pix2, zmax_pix2 = io.read_deltas(args.in_dir2, cf.nside, cf.lambda_abs2, cf.alpha2, cf.zref, cosmo, nspec=args.nspec, no_project=args.no_project, from_image=args.from_image2)
        cf.data2 = data2
        cf.ndata2 = ndata2
