...
def main(cmdargs):
    ...
    t5[w] /= weights[w]
    t6[w] /= weights[w]
    t1 *= 1.0 * num_pairs_used / num_pairs
    t2 *= 1.0 * num_pairs_used / num_pairs
    t3 *= 1.0 * num_pairs_used / num_pairs
    t4 *= 1.0 * num_pairs_used / num_pairs
    t5 *= 1.0 * num_pairs_used / num_pairs
    t6 *= 1.0 * num_pairs_used / num_pairs
